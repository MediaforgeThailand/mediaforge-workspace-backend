...
const RECOMMENDED_WORKSPACE_PRICING: CreditCostWriteRow[] = [
  ...
  { feature: "model_3d", model: "tripo3d-import", label: "Tripo3D Import Model", cost: 1, pricing_type: "per_operation", provider: "tripo3d", price_key: "import_model", source: "official_docs", source_url: "https://docs.tripo3d.ai/model-generation/import-model.html", provider_unit: "per import", notes: "Tripo lists import_model as free; Workspace charges a 1-credit infrastructure floor for upload and job orchestration." },
  { feature: "model_3d", model: "tripo3d-prerigcheck", label: "Tripo3D Pre-Rig Check", cost: 1, pricing_type: "per_operation", provider: "tripo3d", price_key: "animate_prerigcheck", source: "official_docs", source_url: "https://docs.tripo3d.ai/animation/pre-rig-check-v2-0-20250506.html", provider_unit: "per check", notes: "Tripo lists pre-rig check as free; Workspace charges a 1-credit infrastructure floor so the credit path stays positive." },
  { feature: "model_3d", model: "tripo3d-rig", label: "Tripo3D Auto Rig", cost: 250, pricing_type: "per_operation", provider: "tripo3d", price_key: "animate_rig", source: "official_docs", source_url: "https://docs.tripo3d.ai/animation/rig-v2-5-20260210.html", provider_unit: "per rig", notes: "Official Tripo rig cost is 25 credits; Workspace model_3d pricing uses the existing approximate 10x provider-credit convention." },
  { feature: "model_3d", model: "tripo3d-retarget", label: "Tripo3D Animation Retarget", cost: 100, pricing_type: "per_operation", provider: "tripo3d", price_key: "animate_retarget", source: "official_docs", source_url: "https://docs.tripo3d.ai/animation/retarget.html", provider_unit: "per animation task", notes: "Official Tripo retarget cost is 10 credits per animation; batch mode supports up to five presets per task." },
  { feature: "model_3d", model: "tripo3d-conversion", label: "Tripo3D Export Conversion", cost: 50, pricing_type: "per_operation", provider: "tripo3d", price_key: "convert_model", source: "official_docs", source_url: "https://docs.tripo3d.ai/export/conversion.html", provider_unit: "per conversion", notes: "Official Tripo conversion base cost is 5 credits plus optional conversion surcharges; update once invoice/SKU data is reconciled." },
